...
2. update core package (add plugins to app module)
3. Update admin-ui package (add plugins to App component)

## Resources

- [Database design](https://app.sqldbm.com/PostgreSQL/DatabaseExplorer/p278951#)
- [Design](https://www.figma.com/file/halWQHPqjLO01nU7j5Lc50/Vendyx.dev?type=design&node-id=3537-4404&mode=design&t=SG1wUDdLAKriS6zB-0)
- [Diagrams](https://www.figma.com/file/adRrezu8Lrl6ufRbtwlbOw/vendyx.dev---flowcharts?type=whiteboard&node-id=0-1&t=U8n1uIwMglIGIWEH-0)